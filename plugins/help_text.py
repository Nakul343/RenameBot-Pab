...
def help_user(bot, update):
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ Contact DEV ⭕️", url="https://t.me/PabBots")]]),
        parse_mode="html",
...
async def rename_cb(bot, update):
    ...
    await bot.send_message(
        chat_id=update.chat.id,
        text="<b>File Name</b> : <code>{}</code> \n\nSelect the desired option below 😇 @PabBots".format(filename),
...
async def cancel_extract(bot, update):
    ...
    await bot.send_message(
        chat_id=update.chat.id,
        text="Process Cancelled 🙃 @PabBots",
    )
